...
public class TestConfig implements CommandLineRunner{
	...
	@Autowired
	private CategoryRepository categoryReository; //dependencia para usar os metodos da classe JpaRepository
	...
	public void run(String... args) throws Exception {
		...
		//adicionando cada produto a sua categoria
		...
		User u1 = new User(null, "Maria Brown", "9998888", "12345", "maria@gmail.com");
		User u2 = new User(null, "Alex Green", "9997772", "32322", "alex@gmail.com");
		...
		o1.setPayment(pay1); //estanciando em memória
