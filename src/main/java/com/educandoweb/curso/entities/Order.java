...
public class Order implements Serializable{
	...
	@JoinColumn(name = "client_id")//fala qual vai ser o nome da chave estrangeira
	private User client;
	
	@OneToMany(mappedBy = "id.order")
	private Set<OrderItem> items = new HashSet<>();
	
	@OneToOne(mappedBy = "order", cascade = CascadeType.ALL)//é necessario por que o pagamento e o pedido vao ter o mesmo id
